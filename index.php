...
$work = [
    [
        ...
        'description' => 'Принимать заказы на грузоперевозки и распределять заказы , назначать машины и маршрут.',
    ],
    [
        'name' => 'Кассир',
        'dateStart' => 'Июль 2021',
        'dateEnd' => 'Июль 2022',
        'description' => 'Обслуживание людей на кассе , консультация  покупателей, работа в торговом зале.',
    ],
    [
        'name' => 'Администратор в ночном баре',
        'dateStart' => 'Июль 2019',
        'dateEnd' => 'June 2021',
        'description' => 'Организация работы бара, распределение работы, введение отчетной документации по бару.',
    ],
];
?>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <div class="w3-container">
                ...
                <?= $work[$i]['dateStart']; ?> 
                - <span
                class="w3-tag w3-teal w3-round"><?= $work[$i]['dateEnd']; ?></span></h6>
                <?php else:?>
                <?= $work[$i]['dateStart']; ?> - <?= $work[$i]['dateEnd']; ?></h6>
                <?php endif;?>
                <?php ?>
